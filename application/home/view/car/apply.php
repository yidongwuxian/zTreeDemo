    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="widget-header">
                <h4 class="widget-title lighter smaller">申请列表</h4>
            </div>
                        ...
                        <table id="simple-table" class="table table-striped table-bordered table-hover">
                            ...
                            <?php if( ! empty($list)): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date('Y-m-d', $value->use_date);?></td>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs btn-group">
                                            <a class="btn btn-xs btn-info" href="/home/car/applyinfo/id/<?php echo $value->id; ?>">
                                                <i class="ace-icon fa fa-print bigger-120"> 详情 </i>
                                            </a>
