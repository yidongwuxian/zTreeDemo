                    ...
                    <form class="form-horizontal" id="form">
                        <div class="form-group">
                            ...
                            <div class="radio col-sm-10">
                                <label>
                                    <input type="radio" value="1" class="ace" name="mark" checked>
                                    <span class="lbl"> 审核流程</span>
                                </label>
                                <label>
                                    <input type="radio" value="2" class="ace" name="mark">
                                    <span class="lbl"> 派发流程</span>
                                </label>
                                <label>
                                    <input type="radio" value="3" class="ace" name="mark">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="padding-left: 7px;">
                                <span class="ui-spinner ui-widget ui-widget-content ui-corner-all">
                                    <input id="spinner" name="order" type="text" value="1"/>
                                </span>
                                <b>提示:流程按从小到大的顺序排列</b>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <a class="btn btn-info" type="button" id="btn">
                                    <i class="ace-icon fa fa-check bigger-110"></i>
                                    提交
                                </a>
                                <a class="btn" href="/home/car/process">
