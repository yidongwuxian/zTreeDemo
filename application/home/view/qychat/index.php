    ...
    <div class="main-content-inner">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">企业号列表</li>
            </ul><!-- /.breadcrumb -->
        </div>

        <div class="page-content">
            <div class="page-header align-right">
                <a class="btn btn-primary" href="/home/qychat/add">添加企业号</a>
            </div><!-- /.page-header -->

            <div class="widget-box widget-color-blue2">

            <div class="widget-header">
                <h4 class="widget-title lighter smaller">企业号列表</h4>
            </div>
                    ...
                    <div>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <?php if( ! empty($list)): ?>
                                ...
                                <tr>
                                    <td><?php echo $qychat->name; ?></td>
                                    <td><?php echo $qychat->chat_str; ?></td>
                                    <td class="hidden-480"><?php echo $qychat->corp_id; ?></td>
                                    <td><?php echo $qychat->status == 1 ? '启用' : '禁用'; ?></td>
                                    <td class="hidden-480"><?php echo date('Y-m-d',$qychat->create_time); ?></td>
                                    <td class="hidden-480">
                                        <div class="hidden-sm hidden-xs btn-group">
                                            <a class="btn btn-xs btn-info" href="/home/qychat/edit/id/<?php echo $qychat->id; ?>">
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $("[data-type='delete']").click(function(){
            var id = $(this).data('id');
            bootbox.confirm("确定要删除该企业号吗？", function(result) {
                if(result) {
                    var data = {};
                    data.id = id;
                    $.ajax({
                        type : "POST",
                        url : "/home/qychat/delete",
                        data : data,
                        dataType: "json",
