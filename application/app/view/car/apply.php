            ...
            <ul class="mui-table-view mui-table-view-striped mui-table-view-condensed">
                <?php if( ! empty($list)): ?>
                    ...
                    <li class="mui-table-view-cell">
                        <a href="/app/car/applyInfo/id/<?php echo $vo->id ;?>">
                        <div class="mui-table">
...
<script>
    ...
    function pullupRefresh() {
        ...
        setTimeout(function() {
            ...
            //li 加载的list样式参考 搜索结果页底部js部分 search-result.html
            mui.getJSON('/app/car/ajaxdata?page=' + page,function(json){
                if( json.statusCode == 200 ){
                    mui.each(json.data,function(i,item){
                        var li = document.createElement('li');
                        li.className = 'mui-table-view-cell';
                        li.innerHTML = '<a href="/app/car/applyinfo/id/'+ item.id +'">' +
                                        '<div class="mui-table">' +
                                            '<div class="mui-table-cell mui-col-xs-10">' +
